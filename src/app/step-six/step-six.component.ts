...
export class StepSixComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  gridpriceWidgetCommonClass = 'col-md-4 col-6 mt-2 mb-2 form-row animated bounceIn mr-4';
  listpriceWidgetCommonClass = 'col-md-4 my-2 form-row animated bounceIn mr-4';
  viewmode: string;
