const config = {
    ...
    ApiInfo: {
      ...
      homeAPIToken:
        'JK33NT',
      CustPermId:
        'xmlcngtest',//In production mode, this will be 'OPX0158820'
      CustLoginId:
        'xmlcngtest',//This will be same as 'OPX0158820'
      HomeAPIURL:
        'https://api-qua.stillwaterinsurance.com/api/services/rest/home/quote/v1.0', //Test mode,
      // HomeAPIURL:'https://api.stillwaterinsurance.com/api/services/resthome/quote/v1.0'//Production mode,
      BindAPIURL:
