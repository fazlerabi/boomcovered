  ...
  universalData: {
    ...
    roofShapes: [
      ...
      },
      {
        ...
        Name: "Gable",
        Value: "Gable",
        Description: "A type of roof containing sloping planes of the same pitch on each side of the ridge. Contains a gable\n      at each end.",
      ...
      },
      {
        ...
        Name: "Gambrel",
        Value: "Gambrel",
        Description: "A type of roof containing two sloping planes of different pitch on each side of the ridge. The lower\n      plane has a steeper slope than the upper. Contains a gable at each end.",
      ...
      },
      {
        ...
        Name: "Hip",
        Value: "Hip",
        Description: "A type of roof containing sloping planes of the same pitch on each of four sides. Contains no gables.",
      ...
      },
      {
        ...
        Name: "Mansard",
        Value: "Mansard",
        Description: "A type of roof containing two sloping planes of different pitch on each of four sides. The lower plane\n      has a much steeper pitch than the upper, often approaching vertical. Contains no gables.",
      ...
      },
      {
        ...
        Name: "Butterfly",
        Value: "Butterfly",
        Description: "A roof shape which has two surfaces that rise from the center to the eaves with a valley in the center;\n      resembles the wings of a butterfly",
      ...
      },
      {
        ...
        Name: "Shed",
        Value: "Shed",
        Description: "A roof containing only one sloping plane. Has no hips, ridges, valleys or gables.",
    ...
    constructionTypes: [
      {
        ...
        Description: "Single wall (studless) construction framed with light timber trusses.",
      },
      {
        OptionGroupId: "9",
    ...
    foundationTypes: [
      ...
      },
      {
        ...
        Name: "Piers",
        Value: "Piers",
        Description: "Pier foundation is a grid system of girders (beams), piers, and footings used in construction to elevate the superstructure above the ground plane or grade. The piers serve as columns for the superstructure.",
      ...
      },
      {
        ...
        Name: "Slab",
        Value: "Slab",
        Description: "A continuous slab of concrete, generally reinforced with steel re-bar or steel wire mesh, laid over the ground as a foundation for a structure.",
      ...
      },
      {
        ...
        Name: "Crawl Space",
        Value: "Crawl Space",
        Description: "An excavated or unexcavated foundation area below a residence, less than 5 feet in depth, that is generally used for access to plumbing and heating equipment. It can also be used for storage.",
